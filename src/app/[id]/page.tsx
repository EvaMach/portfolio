      ...
      <div className="ml-8">
        <div className="flex justify-between">
          ...
          <div className="hidden md:block text-right">
            <div className="text-gray-400">{`${project.year} ${
        ...
        <div className="grid gap-2 border-b-2 pb-4 border-accent mb-4">
          <div>
            <span className="text-gray-300 font-semibold">Roles: </span>
            {project.roles}
          </div>
          <div>
            <span className="text-gray-300 font-semibold">Team size: </span>
            {project.team}
          </div>
          <div>
            <span className="text-gray-300 font-semibold">Tech stack: </span>
