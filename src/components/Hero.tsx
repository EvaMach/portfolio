...
const Hero = () => (
  ...
  >
    <div className="w-full grid grid-cols-1 md:grid-cols-[3fr_2fr] gap-12 items-center">
      <div>
        <h1 className="hero-line-1 font-extrabold mb-2 leading-tight text-text-primary text-[clamp(2.5rem,5vw,4rem)]">
          {heroContent.heading}
        </h1>
        <h2 className="hero-line-2 font-extrabold mb-2 text-[clamp(1.75rem,4vw,3rem)] leading-[1.15]">
          {heroContent.subheadingPrefix}{" "}
          <span className="gradient-text">
            {heroContent.subheadingHighlight}
          </span>{" "}
          {heroContent.subheadingSuffix}
        </h2>
        <p
